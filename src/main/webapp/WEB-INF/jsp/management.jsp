    ...
    <div class="row">
        <div class="container col s4">
            ...
            <nav class="light-blue lighten-1" role="navigation" style="height: 900px;">
                ...
                <h4 style="padding: 10px;">Management</h4>
                ...
                <ul class="hide-on-med-and-down">
                    ...
                    <li class="col s12"><a class="waves-effect waves-light" href="#"><i class="material-icons left">directions_bus</i>Transport options</a></li>
                </ul>

                <p style="font-size:small; text padding: 20px;" class=""> /* The intention here is for each button to present to the user a category of content. The user can then select an event or accommodation object to edit/delete. */</p>
