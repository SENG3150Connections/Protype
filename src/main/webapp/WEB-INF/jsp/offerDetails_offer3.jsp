        ...
        <div class="container col m9 light-blue lighten-4" style="height: 600px;">
            <div style=" margin-left:20px; height: 520px">
                ...
                <div class="col s6">
                    ...
                    <p> Enjoy all the sights Newcastle Harbour has to offer as we cruise the working port and picturesque foreshore. See the harbours coal loading facilities, tug boats and big ships up-close.

                        Indulge in our freshly prepared buffet lunch consisting of seasoned roasted chicken, double smoked leg ham hand carved off the bone,
                        fresh local prawns, and a selection of salads to compliment.
                        Enjoy a selection of petit fours for dessert with complimentary tea & coffee or select from a full range of drinks available from our fully licensed bar.
                ...
                <div class="col s6">
                    <img ALIGN="right" style="margin-top:110px; width: 340px; height: 250px;" src="images/events/harbour tours.jpg">
                </div>
