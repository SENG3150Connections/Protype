    ...
    <div class="row">
        <div class="container col m9 light-blue lighten-4" style="height: 600px;">
            <div style=" margin-left:20px; height: 520px">
                ...
                <div class="col s6">
                    <h4>Fort Scratchley Tours</h4>
                    <h5>$36</h5>

                    <p> Visit the historic Fort Scratchley for a guided tour. Learn about the rich history of this historic building.</p>

                    <p> Guided tours are led by passionate Fort Scratchley Historical Society volunteers with a wealth of knowledge about the site.
                    ...
                    <p> Tours are available at regular intervals each day the Fort is open (6 days a week, 10am to 4pm closed Tuesdays). You can purchase your tour tickets at the Artillery Store on the day.
